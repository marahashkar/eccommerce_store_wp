...
if ($settings['show_count']) {
    printf('<div class="el-betterdocs-cb-cat-count__layout-2"><span class="count-inner__layout-2">%s</span></div>', BetterDocs_Elementor::get_doc_post_count($term_count, $term->term_id));
}
