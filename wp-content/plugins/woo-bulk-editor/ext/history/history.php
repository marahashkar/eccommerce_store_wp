  ...
  KEY `user_id` (`user_id`)
        ...
        if ($wpdb->query($sql1) === false) {
            ...
            <div class="error notice">
                <p class="description"><?php _e("BEAR cannot create the database table! Make sure that your mysql user has the CREATE privilege! Do it manually using your host panel phpmyadmin!", 'woo-bulk-editor') ?></p>
