...
<b>
    ...
    printf(esc_html__('The plugin has %s, %s, %s list. Also if you have troubles you can %s!', 'woo-bulk-editor'), WOOBE_HELPER::draw_link(array(
                ...
                'title' => '<b style="color: orange;">' . esc_html__('ask for support here', 'woo-bulk-editor') . '</b>',
...
<ol>
    ...
    <li><?php
        printf(__('If your shop is on the Russian language you should install %s for the correct working of BEAR with Cyrillic', 'woo-bulk-editor'), WOOBE_HELPER::draw_link(array(
...
<ul>
    <li style="padding: 7px; border: dashed 1px orange; border-radius: 3px; margin-bottom: 9px;">
        <?php
        printf(__('If you like BEAR %s about what you liked and what you want to see in future versions of the plugin', 'woo-bulk-editor'), WOOBE_HELPER::draw_link([
...
<ul>
    ...
    <li><?php _e('Recommended PHP version', 'woo-bulk-editor') ?>: 8.xx</li>
</ul><br />
